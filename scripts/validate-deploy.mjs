...
const requiredSnippets = [
  ...
  "card factor safe",
  ".card.primary .cv.walk-time{font-size:clamp(21px,6.2vw,24px)",
  ".card.factor .cv{font-size:clamp(25px,7.3vw,29px)",
  ".cv.wind-value{display:grid;grid-template-columns:auto 1fr",
